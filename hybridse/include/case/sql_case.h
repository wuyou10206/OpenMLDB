...
class SqlCase {
 public:
    ...
    static bool ExtractTableDef(const std::string& schema_str, const std::string& index_str,
                                type::TableDef& table);  // NOLINT
    static bool ExtractRows(const codec::Schema& schema, const std::string& data_str,
                            std::vector<hybridse::codec::Row>& rows);  // NOLINT
    static bool ExtractRows(const codec::Schema& schema, const std::vector<std::vector<std::string>>& row_vec,
                            std::vector<hybridse::codec::Row>& rows);  // NOLINT
    ...
    static bool ExtractRow(const codec::Schema& schema, const std::string& row_str, int8_t** out_ptr,
                           int32_t* out_size);
    static bool ExtractRow(const codec::Schema& schema, const std::vector<std::string>& item_vec, int8_t** out_ptr,
                           int32_t* out_size);
